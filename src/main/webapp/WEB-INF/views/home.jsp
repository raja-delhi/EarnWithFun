...
<body>
    ...
    <div id="tabContentDiv">
        <div id="Home" class="tabContent">
          <div id="homeContent">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#instructionLogin">
                  Read Instruction
                </button>
         </div>
        </div>
    ...
    <div class="modal fade" id="instructionLogin" tabindex="-1" role="dialog" aria-labelledby="instructionLogin" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongLoginTitle">Instructions</h5>
